...
// Returns the private 'App\Repository\GeneroRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\GeneroRepository.php';

return $this->privates['App\\Repository\\GeneroRepository'] = new \App\Repository\GeneroRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
