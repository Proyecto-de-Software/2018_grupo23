...
// Returns the private 'App\Repository\MotivoConsultaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MotivoConsultaRepository.php';

return $this->privates['App\\Repository\\MotivoConsultaRepository'] = new \App\Repository\MotivoConsultaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
