...
// Returns the private 'App\Repository\PermisoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PermisoRepository.php';

return $this->privates['App\\Repository\\PermisoRepository'] = new \App\Repository\PermisoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
