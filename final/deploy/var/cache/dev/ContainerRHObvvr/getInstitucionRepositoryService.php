...
// Returns the private 'App\Repository\InstitucionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\InstitucionRepository.php';

return $this->privates['App\\Repository\\InstitucionRepository'] = new \App\Repository\InstitucionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
