...
// Returns the private 'security.authentication.provider.guard.config' shared service.
...
return $this->privates['security.authentication.provider.guard.config'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
...
}, 1), ($this->privates['security.user.provider.concrete.api_user_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_ApiUserProviderService.php')), 'config', ($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())));
