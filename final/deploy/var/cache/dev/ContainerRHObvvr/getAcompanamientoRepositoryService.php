...
// Returns the private 'App\Repository\AcompanamientoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AcompanamientoRepository.php';

return $this->privates['App\\Repository\\AcompanamientoRepository'] = new \App\Repository\AcompanamientoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
