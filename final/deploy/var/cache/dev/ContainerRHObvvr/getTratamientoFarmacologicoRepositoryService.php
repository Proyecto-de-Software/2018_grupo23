...
// Returns the private 'App\Repository\TratamientoFarmacologicoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TratamientoFarmacologicoRepository.php';

return $this->privates['App\\Repository\\TratamientoFarmacologicoRepository'] = new \App\Repository\TratamientoFarmacologicoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
