...
// Returns the private 'App\Repository\TipoInstitucionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TipoInstitucionRepository.php';

return $this->privates['App\\Repository\\TipoInstitucionRepository'] = new \App\Repository\TipoInstitucionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
