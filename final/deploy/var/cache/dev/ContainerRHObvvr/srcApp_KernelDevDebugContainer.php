...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\ConfiguracionController' => 'getConfiguracionControllerService.php',
            'App\\Controller\\ConsultaController' => 'getConsultaControllerService.php',
            ...
            'App\\Controller\\RolesDelSistemaController' => 'getRolesDelSistemaControllerService.php',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('lexik_jwt_authentication.on_authentication_success', [0 => function () {
            return ($this->privates['acme_api.event.authentication_success_listener'] ?? ($this->privates['acme_api.event.authentication_success_listener'] = new \App\EventListener\AuthenticationSuccessListener()));
    ...
    protected function getDebug_Security_FirewallService()
    {
        return $this->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.app' => ['privates', 'security.firewall.map.context.app', 'getSecurity_Firewall_Map_Context_AppService.php', true],
            'security.firewall.map.context.config' => ['privates', 'security.firewall.map.context.config', 'getSecurity_Firewall_Map_Context_ConfigService.php', true],
            ...
            yield 'security.firewall.map.context.dev' => ($this->privates['.security.request_matcher.I0FlUWA'] ?? ($this->privates['.security.request_matcher.I0FlUWA'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/public/')));
            yield 'security.firewall.map.context.login' => ($this->privates['.security.request_matcher.Kq2sQPG'] ?? ($this->privates['.security.request_matcher.Kq2sQPG'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/(login|doc|test)')));
            ...
            yield 'security.firewall.map.context.config' => ($this->privates['.security.request_matcher.x3VUikp'] ?? ($this->privates['.security.request_matcher.x3VUikp'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/configuracion/new')));
            yield 'security.firewall.map.context.app' => ($this->privates['.security.request_matcher.Snw61AH'] ?? ($this->privates['.security.request_matcher.Snw61AH'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(role|user|consulta|paciente)/')));
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['security.authentication.provider.guard.config'] ?? $this->load('getSecurity_Authentication_Provider_Guard_ConfigService.php'));
            yield 4 => ($this->privates['security.authentication.provider.guard.app'] ?? $this->load('getSecurity_Authentication_Provider_Guard_AppService.php'));
        }, 5), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'lexik_jwt_authentication.token_ttl': $value = $this->getEnv('JWT_TOKENTTL'); break;
