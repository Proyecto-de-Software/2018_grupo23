...
// Returns the private 'App\Repository\RolesDelSistemaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RolesDelSistemaRepository.php';

return $this->privates['App\\Repository\\RolesDelSistemaRepository'] = new \App\Repository\RolesDelSistemaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
